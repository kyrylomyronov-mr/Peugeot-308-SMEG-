...
<select id='lang'>
<option value='1'>Французский (Français)</option>
<option value='2'>Английский (English)</option>
<option value='3'>Итальянский (Italiano)</option>
<option value='4'>Испанский (Español)</option>
<option value='5'>Немецкий (Deutsch)</option>
<option value='6'>Голландский (Nederlands)</option>
<option value='7'>Португальский (Português)</option>
<option value='8'>Турецкий (Türkçe)</option>
